 ...
 */
final class Version20260130092648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_horloge ADD mecanisme_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE categorie_horloge ADD CONSTRAINT FK_2519D16FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE categorie_horloge ADD CONSTRAINT FK_2519D16F3FC0D758 FOREIGN KEY (mecanisme_id) REFERENCES mecanisme (id)');
        $this->addSql('CREATE INDEX IDX_2519D16F3FC0D758 ON categorie_horloge (mecanisme_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_horloge DROP FOREIGN KEY FK_2519D16F3FC0D758');
        $this->addSql('DROP INDEX IDX_2519D16F3FC0D758 ON categorie_horloge');
        $this->addSql('ALTER TABLE categorie_horloge DROP mecanisme_id');
