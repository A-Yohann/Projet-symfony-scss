 ...
 */
final class Version20260122133740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) NOT NULL, ADD cotisation_ajour TINYINT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nom, DROP cotisation_ajour');
    }
}
