 ...
 */
final class Version20260130085545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mecanisme ADD categorie_horloge_id INT NOT NULL');
        $this->addSql('ALTER TABLE mecanisme ADD CONSTRAINT FK_71C87194D9821596 FOREIGN KEY (categorie_horloge_id) REFERENCES categorie_horloge (id)');
        $this->addSql('CREATE INDEX IDX_71C87194D9821596 ON mecanisme (categorie_horloge_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mecanisme DROP FOREIGN KEY FK_71C87194D9821596');
        $this->addSql('DROP INDEX IDX_71C87194D9821596 ON mecanisme');
        $this->addSql('ALTER TABLE mecanisme DROP categorie_horloge_id');
