 ...
 */
final class Version20260123122231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_horloge ADD image VARCHAR(255) DEFAULT NULL, ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE categorie_horloge ADD CONSTRAINT FK_2519D16FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_2519D16FA76ED395 ON categorie_horloge (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2519D16FA76ED395 ON categorie_horloge');
        $this->addSql('ALTER TABLE categorie_horloge DROP image, DROP user_id');
